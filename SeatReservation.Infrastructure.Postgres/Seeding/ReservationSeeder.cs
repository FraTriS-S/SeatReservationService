...
public class ReservationSeeder : ISeeder
{
    ...
    public ReservationSeeder(SeatReservationDbContext dbContext, ILogger<ReservationSeeder> logger)
    {
    ...
    private async Task SeedVenuesAndSeatsBatched()
    {
        ...
        for (var i = 0; i < VENUES_COUNT; i++)
        {
            ...
            var venueResult = Venue.Create(null, prefix, name, seatsLimit);
