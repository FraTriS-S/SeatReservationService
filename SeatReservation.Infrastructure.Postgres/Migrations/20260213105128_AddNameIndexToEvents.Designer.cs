...
namespace SeatReservation.Infrastructure.Postgres.Migrations
{
    ...
    [Migration("20260213105128_AddNameIndexToEvents")]
    partial class AddNameIndexToEvents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SeatReservation.Domain.Events.EventDetails", b =>
                {
                    ...
                    b.Property<DateTime?>("LastReservationDateTime")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_reservation_date_time");
            ...
            modelBuilder.Entity("SeatReservation.Domain.User", b =>
                {
                    b.OwnsOne("SeatReservation.Domain.Deatails", "Details", b1 =>
                        {
                            ...
                            b1.OwnsMany("SeatReservation.Domain.SocialNetwork", "Socials", b2 =>
                                {
                                    b2.Property<Guid>("DeatailsUserId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.HasKey("DeatailsUserId", "__synthesizedOrdinal");

                                    b2.ToTable("users");

                                    b2.WithOwner()
                                        .HasForeignKey("DeatailsUserId");
                                });
